        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <AnimatedSection animation="fade-in-up">
            <div className="relative">
              <div className="absolute -left-6 -top-6 w-24 h-24 bg-agrobravo-gold/20 rounded-full"></div>
              <div className="absolute -right-4 -bottom-4 w-16 h-16 bg-agrobravo-gold/30 rounded-full"></div>
          ...
          <AnimatedSection animation="fade-in-up" delay={0.2}>
            <div className="bg-white/50 backdrop-blur-sm p-8 rounded-lg shadow-sm border border-white/20">
              <div className="inline-block px-3 py-1 rounded-full bg-agrobravo-green/10 border border-agrobravo-green/20 mb-4">
                <p className="text-agrobravo-green text-sm font-medium">Sobre a AgroBravo</p>
              </div>
              ...
              <div className="flex items-center text-agrobravo-dark mb-6">
                <MapPin className="mr-2 text-agrobravo-gold" />
